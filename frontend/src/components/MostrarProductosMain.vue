        ...
        <router-link :to="{ name: 'detalle-productos', params: { id: producto.id } }" class="carta-link">
          ...
          <div class="detalles-producto">
            ...
            <div class="informacion">
              ...
              <div class="objeto">
                <img class="icono" src="../assets/iconos/ubicacion.png" alt="direccion"> <span class="texto-azul">A {{
                  calcularKm(producto.punto_entrega?.latitud, producto.punto_entrega?.longitud) }} km de ti</span>
              </div>
